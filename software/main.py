...
class Main:
    def __init__(self, braille_display, text_to_speech: SpeechOutput):
    ...
    def __activate_display(self):
        print(
            f"activating display with page {self.__current_display_page} of {self.__current_display_braille()}"
        )
